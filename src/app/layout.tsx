...
export const metadata: Metadata = {
  ...
  // All icons are static files in /public, generated from the brand wordmark
  // (stacked BAYA / NIHAN) so every surface shows the logo. Google picks the
  // largest square it can find for search results, hence the 192px entry —
  // it ignores .ico files below 48px.
  icons: {
    icon: [
